...
Scene Samples::BasicSphere(std::atomic<i32>* progress)
{
    ...
    Material* sunMat = Material::RegisterMaterial("SunDiffuse", new DiffuseLight(Vector3(1.0f, 0.5f, 0.2f), 1.0f));

    Object* earth  = Object::CreateSphere(Vector3(0, 0, 0), 10, earthMat);
